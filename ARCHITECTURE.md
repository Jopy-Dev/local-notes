...
Status: `src/frontend/` built through Step 11 (launch + shell parity screens, mock data). `src/cli/`, `src/backend/`, `src/shared/`, `src/frontend/editor/` land per `Implementation_Plan.md` waves.
